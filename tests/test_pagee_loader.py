        ...
        with open(abspath(build_fixture_path('source.html')), 'r') as source, \
             ...
             open(abspath(build_fixture_path('img2.png')), 'rb') as img2:
                with tempfile.TemporaryDirectory() as tmp:
                    ...
                    m.get('http://google.com/images/branding/googlelogo/1x/googlelogo_white_background_color_272x92dp.png', content=img1)
                    m.get('http://google.com/textinputassistant/tia.png', content=img2)
